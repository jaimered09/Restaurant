            ...
            <div id='contenedor1' className="row row-cols-1 row-cols-md-3 g-4">
                <div className="col">
                    <div className="card h-100">
                        <img src="public/assets/images/carousel/card1.jpg" className="card-img-top" alt="card1" width="580" height="450" />
                ...
                <div className="col">
                    <div className="card h-100">
                        <img src="public/assets/images/carousel/card3.jpg" className="card-img-top" alt="card2" width="580" height="450"  />
                        <div className="card-body">
                ...
                <div className="col">
                    <div className="card h-100">
                        <img src="public/assets/images/carousel/card2.jpg" className="card-img-top" alt="card3" width="580" height="450"  />
                        <div className="card-body">
