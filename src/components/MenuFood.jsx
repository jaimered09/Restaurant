  ...
  return (
    <>
      ...
      <div className="row row-cols-1 row-cols-md-3 g-10">
        <div className="col">
          <div className="cards">
            <img src="images/combo1 copy.jpg" className="card-img-top" alt="..." width="200" height="350" />
        ...
        <div className="col">
          <div className="cards">
            <img src="images/combo3SI.jpg" className="card-img-top" alt="..." width="200" height="350" />
            <div className="card-body">
        ...
        <div className="col">
          <div className="cards">
            <img src="images/nuggets-de-pollo copy.jpg" className="card-img-top" alt="..." width="200" height="350" />
            <div className="card-body">
        ...
        <div className="col">
          <div className="cards">
            <img src="images/burger copy.jpg" className="card-img-top" alt="..." width="200" height="350" />
            <div className="card-body">
        ...
        <div className="col">
          <div className="cards">
            <img src="images/salsas copy.jpg" className="card-img-top" alt="..." width="200" height="350" />
            <div className="card-body">
        ...
        <div className="col">
          <div className="cards">
            <img src="images/bebidas copy.jpg" className="card-img-top" alt="..." width="200" height="350" />
            <div className="card-body">
